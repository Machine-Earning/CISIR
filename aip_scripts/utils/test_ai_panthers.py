...
def load_and_preprocess_mnist() -> Tuple[Tuple[Tensor, Tensor], Tuple[Tensor, Tensor]]:
    ...
    :return: Tuple of training cme_files (x_train, y_train) and testing cme_files (x_test, y_test).
    """
    # Load MNIST dataset
...
def main():
    ...
    print("Training on imbalanced cme_files:")
    ...
    # Imbalanced cme_files

    print("test on imbalanced cme_files:")
    ...
    print("Accuracy by bins for balanced cme_files:")
    print("Cross Entropy:")
    ...
    print("Accuracy by bins for imbalanced cme_files:")
    print("Cross Entropy:")
