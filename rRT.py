...
def main():
    ...
    plot_tsne_and_save_extended(feature_extractor_plus_head, combined_train_x, combined_train_y, 'rrt_stage1_training_',
                                save_tag=timestamp)
    ...
    plot_tsne_and_save_extended(regressor, combined_train_x, combined_train_y, 'rrt_stage2_training_',
                                save_tag=timestamp)
