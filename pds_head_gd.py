...
def main():
    ...
    :return: None
    """
    title = 'PDS, without batches, frozen features'
    print(title)
    ...
    feature_extractor.load_weights('/home1/jmoukpe2016/keras-functional-api/model_weights_2023-10-04_08-54-53.h5')
    print('weights /home1/jmoukpe2016/keras-functional-api/model_weights_2023-10-04_08-54-53.h5 loaded successfully!')
