...
def main():
    ...
    results['name'] = f'blogf_mlp_amse{alpha_amse:.2f}_apcc{alpha_apcc:.2f}_lambda{lambda_factor:.2f}_dl_ssb'
    ...
    for seed_idx, seed in enumerate(TRIAL_SEEDS):
        for alpha_mse, alphaV_mse, alpha_pcc, alphaV_pcc in alphas:
            for rho in RHO:  # SAM_RHOS:
                ...
                # Initialize wandb
                wandb.init(project="ICMLA-2025-Paper-BlogF", name=experiment_name, config={
                    "patience": patience,
