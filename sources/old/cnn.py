from modules.dataload.ts_modeling import build_dataset, create_cnns, evaluate_model, process_sep_events, prepare_cnn_inputs
...
def main():
    ...
    for inputs_to_use in [['e0.5'], ['e0.5', 'e1.8'], ['e0.5', 'p'], ['e0.5', 'e1.8', 'p']]:
        for add_slope in [True, False]:
            ...
            # Initialize wandb
            wandb.init(project="cnn-ts", name=experiment_name, config={
