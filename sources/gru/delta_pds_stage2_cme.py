...
weight_paths = {
    (True, 0): '/home1/jmoukpe2016/keras-functional-api/final_model_weights_20240323'
               '-080548GRU_e0_5_e1_8_p_slopeTrue_PDS_bs5000_CME0_features.h5',
    (True, 500): '/home1/jmoukpe2016/keras-functional-api/final_model_weights_20240323'
                 '-095738GRU_e0_5_e1_8_p_slopeTrue_PDS_bs5000_CME500_features.h5',
    (False, 0): '/home1/jmoukpe2016/keras-functional-api/final_model_weights_20240323'
                '-115313GRU_e0_5_e1_8_p_slopeFalse_PDS_bs5000_CME0_features.h5',
    (False, 500): '/home1/jmoukpe2016/keras-functional-api/final_model_weights_20240323'
                  '-125946GRU_e0_5_e1_8_p_slopeFalse_PDS_bs5000_CME500_features.h5',
}
            ...
            for freeze in [False, True]:
                for cme_speed_threshold in [0, 500]:
                    for alpha in np.arange(0.1, 1.6, 0.25):
                        ...
                        # Construct the title
                        title = f'GRU_PDS_Stage2_{inputs_str}_slope{str(add_slope)}_frozen{freeze}_alpha{alpha:.2f}_CME{cme_speed_threshold}'
