                ...
                for alpha_mse, alphaV_mse, alpha_pcc, alphaV_pcc in (0.5, 1, 0.1, 0):
                    for rho in [0.]:  # SAM_RHOS:
                        for add_slope in ADD_SLOPE:
                            ...
                            # Construct the title
                            title = f'ATTM_{inputs_str}_amse{alpha_mse:.2f}_apcc{alpha_pcc:.2f}_rho{rho:.2f}'
                            ...
                            # Initialize wandb
                            wandb.init(project="train_attn_msepcc", name=experiment_name, config={
                            ...
                            history = model_sep.fit(
                                ...
                                validation_data=(X_val, {'output': y_val}),
                                callbacks=[
                                    early_stopping,
