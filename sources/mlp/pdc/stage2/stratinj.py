...
weight_paths = {
    ...
    (False, 0):
        '/home1/jmoukpe2016/keras-functional-api/final_model_weights_mlp2_pdcStratInj_bs6000_v8_20241120-142113.h5'
    ,
}
                    ...
                    for alpha_mse, alphaV_mse, alpha_pcc, alphaV_pcc in REWEIGHTS:
                        for freeze in [False]:
                            for rho in RHO:
                                ...
                                # Construct the title
                                title = f'mlp2_pdcS2_amse{alpha_mse:.2f}_v8_fr{freeze}'
