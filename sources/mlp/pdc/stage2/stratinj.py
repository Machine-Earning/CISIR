...
weight_paths = {
    ...
    # # inj min 
    (False, 0):
        '/home1/jmoukpe2016/keras-functional-api/final_model_weights_mlp2_pdcStratInj_bs3600_rho0.10_20241114-181242.h5'
    ,
}
                    ...
                    for alpha_mse, alphaV_mse, alpha_pcc, alphaV_pcc in REWEIGHTS:
                        for freeze in [False, True]:
                            for rho in RHO:
                                ...
                                # Construct the title
                                title = f'mlp2_pdcS2_amse{alpha_mse:.2f}_fr{freeze}'
