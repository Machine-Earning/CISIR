                    ...
                    for alpha_mse, alphaV_mse, alpha_pcc, alphaV_pcc in [(0.5, 1, 0.1, 0)]:
                        for freeze in [False]:
                            for rho in [1e-3]:
                                ...
                                lambda_ = 3.3  # LAMBDA
                                # Construct the title
                                title = f'MLP_pdsS2strat_amse{alpha_mse:.2f}_rho{rho:.2f}_lambda{lambda_}_SES_cheat'
                                ...
                                final_model_sep_stage1.summary()
                                ...
                                # Step 1: Create stratified dataset for the training and test set
