                ...
                for cme_speed_threshold in CME_SPEED_THRESHOLD:
                    for alpha in [0.3, 1, 0.6, 0]:
                        for freeze in [False]:
                            ...
                            # Construct the title
                            title = f'InvesSAM0.9_MLP_S2n_{inputs_str}_frozen{freeze}_alpha{alpha:.2f}_CME{cme_speed_threshold}'
                            ...
                            best_weights_filepath = f"inves_model_weights_{experiment_name}_s2n_reg.h5"
                            ...
                            error_mae = evaluate_mae(model_sep, X_test, y_test)
                            print(f'mae error: {error_mae}')
                            # Log the MAE error to wandb
                            wandb.log({"mae_error": error_mae})

                            # evaluate the model on stage2 cme_files
                            error_mae_train = evaluate_mae(model_sep, X_train, y_train)
