...
def main():
    ...
    results['name'] = f'sepc_apds{alpha_pds:.2f}_mdi_s1_quad_nae'
    rho = RHO_PRE[0]
    ...
    for seed_idx, seed in enumerate(TRIAL_SEEDS):
        for alpha, alphaV in alphas:
            ...
            # Construct the title
            title = f'sepc_apds{alpha_pds:.2f}_mdi_s1_quad_nae_seed{seed}'
            ...
            for fold_idx, (X_subtrain, y_subtrain, X_val, y_val) in enumerate(
                ...
                model_sep.compile(
                    ...
                    loss=lambda y_true, z_pred: mb.pds_loss_vec(
                        y_true, z_pred,
                        phase_manager=pm,
