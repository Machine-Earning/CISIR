...
from modules.training.ts_modeling import build_dataset, create_1dcnn, create_hybrid_model, reshape_X
    ...
    for inputs_to_use in [['e0.5', 'e1.8', 'p']]:
        for add_slope in [True, False]:
            for cme_speed_threshold in [0, 500]:
                ...
                # Construct the title
                title = f'1DCNN_{inputs_str}_slope{str(add_slope)}_PDS_bs{bs}_CME{cme_speed_threshold}'
