    ...
    for seed in SEEDS:
        for alpha_mse, alphaV_mse, alpha_pcc, alphaV_pcc in IMPORTANCE_MOE_INV:
            for rho in RHO_MOE_INV:  # SAM
                ...
                # Construct the title
                title = f'mlp2_amse{alpha_mse:.2f}_v2_moe_cheat_pcc_ce_investigation_B'
                ...
                # Get subset of training data with delta <= 0.0 for training
                X_train_subset, y_train_subset, logI_train_subset, logI_prev_train_subset = get_subset_ds(
                    X_train, y_train, 0.0, None, logI_train, logI_prev_train)
                ...
                # Get subset of test data with delta <= 0.0 for testing
                X_test_subset, y_test_subset, logI_test_subset, logI_prev_test_subset = get_subset_ds(
                    X_test, y_test, 0.0, None, logI_test, logI_prev_test)
