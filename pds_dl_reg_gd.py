...
def main():
    ...
    :return: None
    """
    title = 'PDS, Dense Joint Loss, Regression, without batches'
    print(title)
    ...
    feature_extractor = mb.create_model_pds(input_dim=19, feat_dim=9, hiddens=[18], output_dim=1, with_reg=True)
