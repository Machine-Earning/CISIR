...
def writeCSVFile(data, csvFilename, fieldnames):
    ...
    cme_files : List[Dict[str: any]]
        The CSV cme_files to write. Each index of the list should be a row of cme_files. Each row of cme_files should contain a mapping of fieldname to cell contents.
    csvFilename: str
        The path of the CSV file to write. If already existing, it will be overwritten
    fieldnames: List[str]
        The columns of the resulting CSV. Each row of the cme_files must contain each of these as a key in their dictionary mapped to something otherwise an error will be thrown.
    """
...
def calculate_connection_angle(data, newFeatureName):
    ...
    cme_files : List[Dict[str: str]]
        The CSV file cme_files where each row is a dictionary in the list mapping fieldnames to contents.
...
def main():
    ...
    # Calculate diffusive shock and update the cme_files in-place. Add feature name to fieldnames list
    ...
    # Calculate connection angle and update the cme_files in-place. Add feature name to fieldnames list
    ...
    # Calculate Richardson and update the cme_files in-place. Add feature name to fieldnames list
    ...
    # Write the updated in-place cme_files to the output file
