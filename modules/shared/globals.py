...
PDS_PATIENCE = int(1e3)  # Higher patience
LR_CB_FACTOR = 0.9  # factor for reducing learning rate # gradual decay leads to more stable training
LR_CB_FACTOR_PDS = 0.9  # factor for reducing learning rate # gradual decay leads to more stable training
LR_CB_PATIENCE = 100  # patience for reducing learning rate
LR_CB_PATIENCE_PDS = 100  # patience for reducing learning rate
