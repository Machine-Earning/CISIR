...
START_LR_PDS_S = 1e-1 # starting learning rate for smaller model
...
LR_CB_FACTOR = 0.1  # factor for reducing learning rate
...
WINDOW_SIZE = 25 # NOTE: must be odd
RHO = [1e-1]
REWEIGHTS = [(1.5, 0.75, 0.1, 0)]
REWEIGHTS_S = [(0.5, 0.75, 0.1, 0)]
PDS_RW_S = [(0.5, 0.75)]
PDS_RW = [(1.5, 0.75)]
# PDS_RW = [(0, 0)]
LAMBDA_FACTOR = 3.3
