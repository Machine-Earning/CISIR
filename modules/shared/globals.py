...
LR_CB_MIN_LR_PDS = 1e-5  # Minimum delta for reducing learning rate
...
LR_CB_FACTOR_PDS = 0.95  # factor for reducing learning rate # gradual decay leads to more stable training
LR_CB_PATIENCE = 100  # patience for reducing learning rate
LR_CB_PATIENCE_PDS = 500  # patience for reducing learning rate
