...
BATCH_SIZE = 2500  # Batch size, 2500 is better than 5000 as it is more stochastic
PDS_BATCH_SIZE = 6000  # Batch size for PDS
...
START_LR_PDS = 1e-3  # starting learning rate
LR_CB_MIN_LR_PRE = 1e-5  # Minimum delta for reducing learning rate
WEIGHT_DECAY = 1e-4  # Higher weight decay
WEIGHT_DECAY_PRE = 1e-5  # Higher weight decay for projection layers
MOMENTUM_BETA1 = 0.9  # Higher momentum beta1
BANDWIDTH = 4.42e-2  # Bandwidth for rebalancing
PATIENCE = int(2e3)  # Higher patience
PDS_PATIENCE = int(10e3)  # Higher patience
LR_CB_FACTOR = 0.9  # factor for reducing learning rate # gradual decay leads to more stable training
LR_CB_FACTOR_PRE = 0.95  # factor for reducing learning rate # gradual decay leads to more stable training
LR_CB_PATIENCE = 100  # patience for reducing learning rate
LR_CB_PATIENCE_PRE = 500  # patience for reducing learning rate
