...
def plot_tsne_and_save(model, X, y, file_path):
    """
    Applies t-SNE to the features extracted by the given model and saves the plot in 2D.
    ...
    Returns:
    - Saves a 2D t-SNE plot to the specified file path
    """
...
def main():
    ...
    # training
    mb.train_features_fast(feature_extractor, shuffled_train_x, shuffled_train_y, shuffled_val_x, shuffled_val_y,
                           epochs=200, batch_size=768)

    plot_tsne_and_save(feature_extractor, shuffled_train_x, shuffled_train_y, 'training_tsne_plot.png')

    plot_tsne_and_save(feature_extractor, shuffled_test_x, shuffled_test_y, 'testing_tsne_plot.png')
